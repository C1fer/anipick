            ...
            <div className="bg-muted/50 border border-border/50 rounded-xl p-1 flex gap-1">
                {lists.mediaTypes.map(({ label, value }) => (
                    <motion.button
                        ...
                        className={twMerge([
                            'select-none flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:pointer-events-none',
